    ...
    <section className="bg-gray-800 text-white">
      <div className="mx-auto max-w-screen-xl px-4 py-20 lg:flex">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="bg-gradient-to-r from-purple via-lightPurple to-newPurple bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl">
          {/* <h1 className="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"> */}
            All Of Your Products
            <span className="sm:block"> Are Just One Click Away. </span>
          </h1>
